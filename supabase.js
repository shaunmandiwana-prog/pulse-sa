...
async function dispatchAgentWelcomeEmail(agentData) {
    ...
    const payload = {
        ...
        message_body: `Ndaa ${agentData.firstname || 'Agent'}!\n\nWelcome to Pulse SA — we truly appreciate you stepping up to take on this vital task as a Field Researcher!\n\nWHAT YOU WILL DO:\nAs a verified Field Researcher, you are the eyes and ears on the ground in your township. You will visit local micro-enterprises (spaza shops, street food vendors, hair salons), log honest daily prices, snap wholesale receipts, and confirm trading activity. Your work builds the verified credit and economic dossiers that help unbanked township businesses qualify for working capital financing and micro-insurance.\n\nOUR GOLDEN RULE — 100% HONESTY & INTEGRITY:\nBanks, credit underwriters, and community leaders make real financial decisions based on the data you collect. At all times, you must act with absolute honesty and integrity. Any fake, fabricated, or misleading data, fake photos, or dishonest behavior is strictly unacceptable and will result in an immediate permanent ban and forfeiture of all points.\n\nYOUR OFFICIAL CREDENTIALS:\n• Agent Name: ${agentData.firstname ? `${agentData.firstname} ${agentData.surname || ''}`.trim() : 'Agent'}\n• Official Agent ID: ${agentData.agentId || 'PSA-ZA-2026'}\n• Certification: Level 1 Certified Field Researcher\n• Starting Balance: +2,500 Pulse Points (+R25 Welcome Bonus)\n\nOfficial Agent Terms & POPIA Policy: https://pulseintel.co.za/Pulse_SA_Agent_Terms_and_POPIA_Policy.pdf\nAgent Web App: https://pulseintel.co.za/agent.html\n\nWarm regards,\nShaun Mandiwana & The Pulse SA Operations Team\npartners@pulseintel.co.za | https://pulseintel.co.za`
    };
